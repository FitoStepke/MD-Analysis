...
# Analysis
universe = MDAnalysis.Universe("hCx46_3Ca.psf", "MD_500ns_3Ca_r2.dcd")
select = "byres name OH2 and cyzone 10.0 15.0 -15.0 protein"
sp = SP(universe, select, verbose=True)
sp.run(start=0, stop=499, tau_max=20)
...
plt.title('$K^{+}$ Survival Probability, 3 $Ca^{+2}$ model R2', fontsize=30)
